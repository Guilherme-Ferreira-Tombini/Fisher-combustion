...
export default function ChangeColor(){
    ...
    useEffect(() => {
        ...
        if (header && body && topics && principal && content && footer && seta && botao) {
            ...
            content.style.backgroundColor = checked ? '#7E4434':'#C35A40';
            ...
            changeColors(Array.from(topics), checked ? '#7E4434' : '#C35A40');
            changeColors(Array.from(principal), checked ? '#7E4434' : '#C35A40');
        }
